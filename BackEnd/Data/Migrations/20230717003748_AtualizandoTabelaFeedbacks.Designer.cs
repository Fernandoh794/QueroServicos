...
namespace QueroServicos.Migrations
{
    ...
    [Migration("20230717003748_AtualizandoTabelaFeedbacks")]
    partial class AtualizandoTabelaFeedbacks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QueroServicos.Models.UserFeedback", b =>
                {
                    b.HasOne("QueroServicos.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QueroServicos.Models.User", "UserContratante")
                        .WithMany()
                        .HasForeignKey("UserIdContratante")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("User");

                    b.Navigation("UserContratante");
                });
